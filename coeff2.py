...
for i in range(len(Q_list)):
    ...
    K_branch = ffit.K_branch_converging_Crane(D_run=Drun, D_branch=Dbranch, Q_run=Q_straight, Q_branch=Q_branch, angle=90.)
    K_run = ffit.K_run_converging_Crane(D_run=Drun, D_branch=Dbranch, Q_run=Q_straight, Q_branch=Q_branch, angle=90.)
    ...
    head_loss_branch_2 = 0.5*rho*v_tot**2*mod.Kxout(1.,Q_branch,Q_tot,Abranch,Arun)
    head_loss_run_2 = 0.5*rho*v_tot**2*mod.Kyout(1.,Q_branch,Q_tot)
